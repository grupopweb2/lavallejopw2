...
<header>
 ...
 <aside>
   <ul class="navbar">
			...
			<% } %>
			<li><a href="registrar.jsp"><div class='barra'></div><p class='menu'>Registrarse Nivel 1</p></a></li>
			<li><a href="redireccionar?site=registraradmin"><div class='barra'></div><p class='menu'>Registrarse Nivel 2</p></a></li>
   ...
   <nav>
   <ul class="stroke">Registrar (Administrador)</ul>
<center>
