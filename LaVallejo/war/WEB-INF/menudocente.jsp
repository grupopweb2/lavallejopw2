...
<nav>
  <ul class="stroke">Menú docente
	...
	<form name="formBusqueda" action="/menudocente" method="get">
	...
	<br>
		...
		&nbsp; &nbsp; &nbsp; 
		<a href="menudocente?action=mostrar">mostrar todos</a>
	</form>
	</fieldset>
	...
	<fieldset class="form">
		<legend>REGISTRAR NUEVO ALUMNO</legend>
				...
				<form name="formRegistroDocente" action="menudocente" method="post">
